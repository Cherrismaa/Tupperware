    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        ...
        <div className="bg-gradient-primary text-primary-foreground py-2 px-4 text-center text-xs sm:text-sm font-medium">
          <p>🎉 Limited Time Offer: Buy ₹5500 & Get ₹1000 Off! | Free Shipping on ₹3500+ </p>
        </div>
        ...
        <div className="container mx-auto flex h-14 items-center justify-between px-4 gap-4">
          ...
          <Link to="/" className="flex items-center space-x-2 flex-shrink-0">
            ...
            <div className="flex items-center">
              <span className="text-xl sm:text-2xl font-bold text-primary">Tupperware</span>
              <span className="text-[10px] text-muted-foreground ml-1 hidden sm:block">Hyderabad</span>
            </div>
          </Link>
