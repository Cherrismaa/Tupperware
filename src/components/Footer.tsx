        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="mb-4">
              ...
              <span className="text-2xl font-bold text-[#e92063]">Tupperware</span>
              <span className="block text-xs text-white/60 mt-1">Hyderabad</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                href="mailto:contacttupperwarestore@gmail.com"
                className="flex items-center gap-2 text-sm text-white/70 hover:text-[#e92063] transition-colors"
              >
                <Mail className="h-4 w-4 flex-shrink-0" />
                <span>contacttupperwarestore@gmail.com</span>
              </a>
