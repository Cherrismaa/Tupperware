        ...
        <div className="relative group">
          ...
          >
            {images.map((image, index) => (
              <div
                key={image.id}
                className={`${compact ? "min-w-[70vw] sm:min-w-[45%] md:min-w-[30%]" : "min-w-[75vw] sm:min-w-[50%] md:min-w-[33%] lg:min-w-[25%]"} flex-shrink-0`}
              >
                <div
                ...
                >
                  ...
                  <div className="absolute top-2 left-2 md:top-3 md:left-3">
                    <span className="px-2 py-0.5 md:px-3 md:py-1 text-[10px] md:text-xs font-semibold bg-[#e92063] text-white rounded-full">
                      {image.label}
                    </span>
                  </div>
                  
                  {/* Zoom Icon */}
                  <div className="absolute top-2 right-2 md:top-3 md:right-3 opacity-0 group-hover/card:opacity-100 transition-opacity">
                    <div className="p-1.5 md:p-2 bg-background/90 rounded-full">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-2 md:p-4">
                    ...
                    {showDetails && image.productsUsed && (
                      <p className="text-white/80 text-[10px] md:text-xs mt-1 line-clamp-1">
